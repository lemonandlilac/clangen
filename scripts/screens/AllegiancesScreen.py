...
class AllegiancesScreen(Screens):
    ...
    def get_hovered_tts_element(self, mouse_x, mouse_y):
        if (
            ...
            and self.heading.hover_point(mouse_x, mouse_y)
        ):
            return self.heading

        for rank_box in self.ranks_boxes:
            if (
                rank_box is not None
                and rank_box.visible
                and rank_box.hover_point(mouse_x, mouse_y)
            ):
                return rank_box
        ...
        for name_box in self.names_boxes:
            if (
                ...
                and name_box.visible
                and name_box.hover_point(mouse_x, mouse_y)
            ):
                return name_box
